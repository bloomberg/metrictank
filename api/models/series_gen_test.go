...
func TestMarshalUnmarshalSeriesRaw(t *testing.T) {
	v := SeriesRaw{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgSeriesRaw(b *testing.B) {
	v := SeriesRaw{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgSeriesRaw(b *testing.B) {
	v := SeriesRaw{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalSeriesRaw(b *testing.B) {
	v := SeriesRaw{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeSeriesRaw(t *testing.T) {
	v := SeriesRaw{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeSeriesRaw(b *testing.B) {
	v := SeriesRaw{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeSeriesRaw(b *testing.B) {
	v := SeriesRaw{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
