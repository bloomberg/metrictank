...
// DecodeMsg implements msgp.Decodable
func (z *SeriesRaw) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
	...
	for zb0001 > 0 {
		...
		case "Datapoints":
			z.Datapoints, err = dc.ReadBytes(z.Datapoints)
			if err != nil {
				err = msgp.WrapError(err, "Datapoints")
				return
			}
...
// EncodeMsg implements msgp.Encodable
func (z *SeriesRaw) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 12
	// write "Target"
	err = en.Append(0x8c, 0xa6, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74)
	if err != nil {
	...
	err = en.WriteBytes(z.Datapoints)
	if err != nil {
		err = msgp.WrapError(err, "Datapoints")
		return
	}
...
// MarshalMsg implements msgp.Marshaler
func (z *SeriesRaw) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 12
	// string "Target"
	o = append(o, 0x8c, 0xa6, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74)
	...
	// string "Datapoints"
	o = append(o, 0xaa, 0x44, 0x61, 0x74, 0x61, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73)
	o = msgp.AppendBytes(o, z.Datapoints)
	return
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *SeriesRaw) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
	...
	for zb0001 > 0 {
		...
		case "Datapoints":
			z.Datapoints, bts, err = msgp.ReadBytesBytes(bts, z.Datapoints)
			if err != nil {
				err = msgp.WrapError(err, "Datapoints")
				return
			}
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *SeriesRaw) Msgsize() (s int) {
	s = 1 + 7 + msgp.StringPrefixSize + len(z.Target) + 5 + msgp.MapHeaderSize
	if z.Tags != nil {
		for za0001, za0002 := range z.Tags {
			_ = za0002
	...
	s += 11 + msgp.BytesPrefixSize + len(z.Datapoints)
	return
}
