...
func (z *GetDataRespRawV1) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	...
	for zb0001 > 0 {
		...
		case "Series":
			...
			if cap(z.Series) >= int(zb0002) {
				...
				z.Series = make([]SeriesRaw, zb0002)
			}
...
func (z *GetDataRespRawV1) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 2
	// write "Stats"
...
func (z *GetDataRespRawV1) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *GetDataRespRawV1) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *GetDataRespRawV1) Msgsize() (s int) {
	s = 1 + 6 + z.Stats.Msgsize() + 7 + msgp.ArrayHeaderSize
	for za0001 := range z.Series {
