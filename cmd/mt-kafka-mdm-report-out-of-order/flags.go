...
func (flags *Flags) Usage() {
	...
	fmt.Fprintln(os.Stderr, "  out-of-order metric points for tag=\"fruit\" value=\"lemon\" count=23 percentGroup=2.622577 percentClass=0.593089 percentTotal=0.000848")
	fmt.Fprintln(os.Stderr, "  out-of-order metric points for tag=\"fruit\" value=\"mango\" count=863 percentGroup=3.585972 percentClass=22.253739 percentTotal=0.031836")
	...
	fmt.Fprintln(os.Stderr, "  duplicate metric points for tag=\"fruit\" value=\"avocado\" count=3962 percentGroup=17.112253 percentClass=31.050157 percentTotal=0.146156")
	fmt.Fprintln(os.Stderr)
	...
	fmt.Fprintln(os.Stderr, "  percentGroup: out of all of the metric points with the same name/tag (depending on grouping), what percentage of them were out-of-order/duplicates (depending on classification)?")
	fmt.Fprintln(os.Stderr, "                the example above shows that ~5.85% of all metric points with tag fruit=apple were out of order")
	...
	fmt.Fprintln(os.Stderr, "                the example above shows that ~2.06% of all metric points that were out of order had tag fruit=apple")
